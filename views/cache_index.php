...
<?php  foreach ($posts as $post) : ?>
  <?php  $author = findUserById($post['user_id']); ?>
<div class="row mt-4">
  <div class="col-lg-12">
    <div class="card">
      <div class="card-header">
        <a href="/post/view/<?php echo(htmlentities($post['id'])); ?>"><span class="h4"><?php echo(htmlentities($post['title'])); ?></span></a><span class="text-muted float-right"> Posted <?php echo(htmlentities(time2str($post['datestamp']))); ?> by <a href="/user/view/<?php echo(htmlentities($post['user_id'])); ?>"><?php echo(htmlentities($author['firstName'])); ?> <?php echo(htmlentities($author['lastName'])); ?></a></span>
      </div>
      <div class="card-body">
